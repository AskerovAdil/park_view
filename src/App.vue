<template>
    <div
                ...
                <div
                    ...
                    <div
                            ...
                            <li
                                ...
                                <div nav-dropdown="pages"
                                    ...
                                    <div class="lg:hidden lg-max:overflow-x-hidden">
                                        <div
                                            class="flex items-center py-2 mb-0 font-bold text-sm whitespace-nowrap text-slate-700">
                                            <div class="inline-block">
                                                <div
                                        ...
                                        <div
                                            class="flex items-center py-2 mt-4 mb-0 font-bold text-sm whitespace-nowrap text-slate-700">
                                            <div class="inline-block">
                                                <div
                                                    class="flex items-center justify-center w-6 h-6 mr-2 text-center text-black bg-center rounded-lg fill-current bg-gradient-to-tl from-purple-700 to-pink-500 stroke-none">
                                ...
                                <div nav-dropdown="authentication"
                                    ...
                                    <div class="flex flex-wrap -mx-3 lg:hidden lg-max:overflow-x-hidden">
                                        <div class="flex flex-col justify-center w-full max-w-full px-3 flex-0">
                                            <h6
                                                class="flex px-0 py-2 mb-0 font-bold text-sm text-slate-700 whitespace-nowrap">
                                                Sign In</h6>
                                            ...
                                            <h6
                                                class="flex px-0 py-2 mt-4 mb-0 font-bold text-sm text-slate-700 whitespace-nowrap">
                                                Sign Up
                                            </h6>
                                                ...
                                                <a class="block clear-both w-full px-4 py-2 font-normal bg-transparent border-0 rounded-lg text-slate-500 hover:text-slate-700 hover:bg-gray-200 text-align-inherit whitespace-nowrap lg:transition-colors lg:duration-300 lg:ease-soft"
                                                    ...
                                                    <div class="flex">
                                                        ...
                                                        <div class="flex items-center justify-between w-full">
                                                            <div>
                                                                <p
                                                                    class="block p-0 mb-0 text-sm whitespace-nowrap text-slate-700">
                                                                    Kanban</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="flex flex-wrap -mx-3 lg:hidden lg-max:overflow-x-hidden">
                                        <div class="w-full max-w-full px-3 md:w-full md:flex-0 shrink-0">
                                            <a class="py-2 pl-4 rounded-lg" href="@/pages/applications/kanban.html">
                                                <div class="flex">
                                                    <div
                                                        class="flex mt-1 mr-4 text-black fill-current stroke-none h-4 w-4">
                                                        <i
                                                            class="relative text-transparent ni leading-none ni-single-copy-04 bg-gradient-to-tl from-purple-700 to-pink-500 bg-clip-text z-1"></i>
                                                    </div>
                                                    <div class="flex items-center justify-between w-full">
                                                    ...
                                                    <div class="flex">
                                                        ...
                                                        <div>
                                                            <h6
                                                                class="flex p-0 mb-0 font-bold text-sm whitespace-nowrap text-slate-700">
                                                                Plugins</h6>
                                                            <span class="leading-normal text-sm">Check how you
                                                                can integrate our plugins</span>
                                                        </div>
                                                    </div>
                                                </a>
                                            </li>
                                                ...
                                                <div class="flex">
                                                    ...
                                                    <div>
                                                        <h6
                                                            class="flex p-0 mb-0 font-bold text-sm whitespace-nowrap text-slate-700">
                                                            Getting Started</h6>
                                                        <span class="leading-normal text-sm">All about overview,
                                                ...
                                                <div class="flex">
                                                    ...
                                                    <div>
                                                        <h6
                                                            class="flex p-0 mb-0 font-bold text-sm whitespace-nowrap text-slate-700">
                                                            Plugins</h6>
                                                        <span class="leading-normal text-sm">Check how you can
                        ...
                        <ul class="hidden pl-0 mb-0 list-none lg:block lg:flex-row">
                            ...
                            <router-link v-if="this.LogginUser?.id != null" :to="'User/Details/' + this.LogginUser?.id"
                                class="flex shrink-0 items-center bg-white hover:bg-gray-50">
                                <img alt="Man"
        ...
        <div v-else @click="showHeader = !showHeader" :class="{ 'opacity-30': isScroll }"
            class="opacity-80  w-full z-50 navbar flex fixed mb-10 shadow-lg xl:col-span-3 bg-neutral-focus text-neutral-content rounded-box">
            <div class=" px-2 mx-2">
                <span class="text-lg font-bold">
                    Проектный парк
                </span>
            </div>
            <div class=" justify-center flex-1 px-2 mx-2">
                <div class="hidden lg:flex">
                    <router-link to='/News/Index' class="">
                        <div class="btn btn-ghost rounded-btn">
                            Новости
                        </div>
                    </router-link>
                    <router-link to='/Project/Index' class="">
                        <div class="btn btn-ghost rounded-btn">
                            Проекты
                        </div>
                    </router-link>
                    <!--<div class="btn btn-ghost rounded-btn">
                            <router-link to='/Publications/Create' class="">
                                Публикации
                            </router-link>
                        </div>-->
                    <router-link to='/Users/Index' class="">
                        <div class="btn btn-ghost rounded-btn">
                            Пользователи
                        </div>
                    </router-link>
                    <router-link v-if="isAdmin()" to='/Publications/Create' class="">
                        <div class="btn btn-ghost rounded-btn">
                            Добавить публикацию
                        </div>
                    </router-link>
            ...
            <div class=" justify-end items-center gap-4">
                <div v-if="this.LogginUser?.firstName == undefined" class="flex gap-2">
                    <router-link to="/Login"
                        class="inline-flex items-center justify-center w-full px-5 py-2 text-white bg-none border border-white rounded-2xl sm:w-auto">
                        Войти
                    </router-link>
                    <span aria-hidden="true" class="block w-px my-auto h-6 bg-gray-200 rounded-full"></span>
                    <router-link v-if="windowWidth() > 500" to="/Register"
                        class=" inline-flex items-center justify-center w-full px-5 py-2 text-white bg-none border border-white rounded-2xl sm:w-auto">
                        Зарегистрироваться
                    </router-link>
                </div>
                <button v-else type="button"
                    class="dropdown dropdown-center group flex shrink-0 items-center rounded-lg transition">
                    <div tabindex="1" class="flex">
                        <circle-user :User="this.LogginUser" />
                        <p class="ml-2 hidden text-left text-xs sm:block">
                            <strong class="block font-medium">{{ this.LogginUser?.firstName + ' ' +
                                    this.LogginUser?.lastName
                            }}</strong>
                            <span v-if="this.LogginUser?.email" class="text-gray-500"> {{ this.LogginUser?.email }}
                            </span>
                        </p>
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="ml-4 my-auto hidden h-5 w-5 text-gray-500 transition group-hover:text-gray-700 sm:block"
                    ...
                    <ul tabindex="0"
                        class="mt-36  shadow menu bg-neutral-focus dropdown-content rounded-box whitespace-nowrap ">
                        <li>
                            <div @click="Logout"
                                class=" m-4 inline-flex items-center justify-center w-full px-5  text-white btn bg-red-600 border border-red rounded-2xl sm:w-auto">
                                Выйти
                            </div>
                        </li>
                    </ul>
        ...
        <div v-if="showHeader && windowWidth() <= 977" class="text-white justify-center flex-1 px-2 mx-2 pt-16">
            <div class="fixed w-11/12 grid grid-cols-1 bg-neutral-focus rounded-lg opacity-80">
                <router-link to='/News/Index' class="">
                    <div class="btn btn-ghost rounded-btn">
                        Новости
                    </div>
