<template class="container">
        ...
        <div v-if="this.isNewDesign" class="container mx-auto my-5 space-y-4 pb-20">
...
<script>
    import ProjectCard from './Resourse/ProjectCard.vue'
    ...
    export default {
        components:{
            ProjectCard,ButtonCreate,ProjectCardNew
        },
        data(){
            return{
                ListProject:[1,3],
