<template>
    ...
    <main-block :Name="'Отзывы'" :Description="'Озывы и пожелания от участников'">

        <swiper class="swiper mx-auto w-full" :modules="modules" :space-between="30" :slides-per-view="3"
