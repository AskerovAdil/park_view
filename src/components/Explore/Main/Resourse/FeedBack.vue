<template>
    <section class=" text-gray-600 body-font relative">
        <div class="shadow-xl  container px-5 py-8 bg-white rounded-2xl mx-auto flex sm:flex-nowrap flex-wrap">
            <div
            ...
            <div class="p-8 lg:w-1/3 md:w-1/2  flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
